...
////////////////////////////////CESAR///////////////////////////////////////////////
Route::get('HistoriaCsr',[HistoryController::class, 'HistoriaCs1'])->name('mmmya'); 

/////////////////////////////// ATLANTICO //////////////////////////////////////////
Route::get('HistoriaATL1', [HistoryController::class, 'HistoriaATL1'])->name('lulu');
Route::get('HistoriaATL2', [HistoryController::class, 'HistoriaATL2'])->name('ma');
Route::get('HistoriaATL3', [HistoryController::class, 'HistoriaATL3'])->name('mohana');
Route::get('HistoriaATL4', [HistoryController::class, 'HistoriaATL4'])->name('ladificil');

///////////////////////////// LA GUAJIRA //////////////////////////////////////////////

Route::get('HistoriaLG1', [HistoryController::class, 'HistoriaLG1'])->name('francis');
Route::get('HistoriaLG2', [HistoryController::class, 'HistoriaLG2'])->name('kera');
Route::get('HistoriaLG3', [HistoryController::class, 'HistoriaLG3'])->name('jimy');
Route::get('HistoriaLG4', [HistoryController::class, 'HistoriaLG4'])->name('secuida');

//////////////////////////// ARAUCA /////////////////////////////////


Route::get('HistoriaAR1', [HistoryController::class, 'HistoriaAR1'])->name('sailor');
Route::get('HistoriaAR2', [HistoryController::class, 'HistoriaAR2'])->name('maveric');
Route::get('HistoriaAR3', [HistoryController::class, 'HistoriaAR3'])->name('supers');
Route::get('HistoriaAR4', [HistoryController::class, 'HistoriaAR4'])->name('aguas');


///////////////////////// BOLIVAR /////////////////////////////////

Route::get('HistoriaBV1', [HistoryController::class, 'HistoriaBV1'])->name('animeuwu');
Route::get('HistoriaBV2', [HistoryController::class, 'HistoriaBV2'])->name('elnazareno');
Route::get('HistoriaBV3', [HistoryController::class, 'HistoriaBV3'])->name('sñoria');
Route::get('HistoriaBV4', [HistoryController::class, 'HistoriaBV'])->name('cojocaballo');

/////////////////////////// CALDAS ////////////////////////////

Route::get('HistoriaCD1', [HistoryController::class, 'HistoriaCD1'])->name('patetarru');
Route::get('HistoriaCD2', [HistoryController::class, 'HistoriaCD2'])->name('mamonte');
Route::get('HistoriaCD3', [HistoryController::class, 'HistoriaCD3'])->name('palone');
Route::get('HistoriaCD4', [HistoryController::class, 'HistoriaCD'])->name('aguerque');

////////////////////// CESAR ////////////////

Route::get('HistoriaCS1', [HistoryController::class, 'HistoriaCS1'])->name('leyanta');
Route::get('HistoriaCS2', [HistoryController::class, 'HistoriaCS2'])->name('espantoye');
Route::get('HistoriaCS3', [HistoryController::class, 'HistoriaCS3'])->name('caballitos');
Route::get('HistoriaCS4', [HistoryController::class, 'HistoriaCS4'])->name('laseiv');

////////////////// NORTE DE SANTANDER ///////////////////////

Route::get('HistoriaNST1', [HistoryController::class, 'HistoriaNST1'])->name('eyvalemia');
Route::get('HistoriaNST2', [HistoryController::class, 'HistoriaNST2'])->name('laitree');
Route::get('HistoriaNST3', [HistoryController::class, 'HistoriaNST3'])->name('espant');
Route::get('HistoriaNST4', [HistoryController::class, 'HistoriaNST4'])->name('elborrach');

/////////////////// QUINDIO //////////////////////////////

Route::get('HistoriaQN', [HistoryController::class, 'HistoriaQN1'])->name('ances');
Route::get('HistoriaQN2', [HistoryController::class, 'HistoriaQN2'])->name('mamont');
Route::get('HistoriaQN3', [HistoryController::class, 'HistoriaQN3'])->name('ehoraski');
Route::get('HistoriaQN4', [HistoryController::class, 'HistoriaQN4'])->name('alcoliriz');

///////////////// RISARALDA ///////////////////////////////

Route::get('HistoriaRL1', [HistoryController::class, 'HistoriaRL1'])->name('chimpum');
Route::get('HistoriaRL2', [HistoryController::class, 'HistoriaRL2'])->name('sanrrose');
Route::get('HistoriaRL3', [HistoryController::class, 'HistoriaRL3'])->name('aguero');
Route::get('HistoriaRL4', [HistoryController::class, 'HistoriaRL4'])->name('presagio');

///////////// TOLIMA /////////////////////////

Route::get('HistoriaTL1', [HistoryController::class, 'HistoriaTL1'])->name('elrango');
Route::get('HistoriaTL2', [HistoryController::class, 'HistoriatL2'])->name('elechon');
Route::get('HistoriaTL3', [HistoryController::class, 'HistoriaTL3'])->name('medicas');
Route::get('HistoriaTL4', [HistoryController::class, 'HistoriaT4'])->name('indigenas');


////////////////// ANTIOQUIA /////////////////////////

Route::get('HistoriaAN1', [HistoryController::class, 'HistoriaAN1'])->name('jamarro');
Route::get('HistoriaAN2', [HistoryController::class, 'HistoriaAN2'])->name('animaso');
Route::get('HistoriaAN3', [HistoryController::class, 'HistoriaAN3'])->name('medicas');
Route::get('HistoriaAN4', [HistoryController::class, 'HistoriaAN4'])->name('horaki');


////////////////// CORDOBA //////////////////////

Route::get('HistoriaCB1', [HistoryController::class, 'HistoriaCB1'])->name('agueroco');
Route::get('HistoriaCB2', [HistoryController::class, 'HistoriaCB2'])->name('griton');
Route::get('HistoriaCB3', [HistoryController::class, 'HistoriaCB3'])->name('aguja');
Route::get('HistoriaCB4', [HistoryController::class, 'HistoriaCB4'])->name('anime');

//////////////////// MAGDALENA ////////////////////////

Route::get('HistoriaMG1', [HistoryController::class, 'HistoriaMG1'])->name('caiman');
Route::get('HistoriaMG2', [HistoryController::class, 'HistoriaMG2'])->name('pata');
Route::get('HistoriaMG3', [HistoryController::class, 'HistoriaMG3'])->name('brama');
Route::get('HistoriaMG4', [HistoryController::class, 'HistoriaMG4'])->name('casad');

////////////////////// CHOCO //////////////////////////

Route::get('HistoriaC1', [HistoryController::class, 'HistoriaC1'])->name('mohan');
Route::get('HistoriaC2', [HistoryController::class, 'HistoriaC2'])->name('anima');
