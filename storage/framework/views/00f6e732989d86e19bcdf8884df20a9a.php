...
Según relata uno de los abuelos, la historia va más o menos así: “resulta que yo estaba ajuntao con la abuela pero tenía amores con una muchacha que vivía como a una hora de camino y yo me volaba tarde de la noche a visitarla</p>
            <a href="<?php echo e(route('sailor')); ?>">Leer más</a>
...
Cuenta también la tradición primitivo-popular de Arauca que en el preciso momento que la serpiente se remueva invirtiendo su posición, es decir, cuando su enorme cabeza ocupe el lugar que tenía la cola, se produce el hundimiento de la Iglesia de Santa Bárbara de Arauca. Para sacar la serpiente, hay que tirarle un Viernes Santo un ramal de anzuelos con siete niños sin bautizo.
            ...
            <a href="<?php echo e(route('maveric')); ?>">Leer más</a>
...
Se cree que si uno unta limón en la mordedura de un perro, habiendo dejado la mitad del limón en el árbol cuando está se seque y caiga, se le caerán los dientes al perro. 
            ...
            <a href="<?php echo e(route('supers')); ?>">Leer más</a>
...
<?php /**PATH C:\xampp\htdocs\Magica_colombia\resources\views////Departamentos/tarjetaArauca.blade.php ENDPATH**/ ?>