        ...
        <div class="row">
            ...
            text-align: center;;">
                <form style=".hover{
                    ...
                    color: rgb(139, 0, 0);}" action="<?php echo e(route('guardarHistoria')); ?>" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH C:\xampp\htdocs\Magica_colombia\resources\views/formularioHistoria.blade.php ENDPATH**/ ?>