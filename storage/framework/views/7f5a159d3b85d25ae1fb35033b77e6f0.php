...
<div class="container">
    <div class="tarjetas">
        <figure>
            <img src="<?php echo e(asset('local_storage/img/any.jpg')); ?>" >
        </figure>
        <div class="contenido">
...
Humberto Currea, pescador nacido en esta tierra, explica que en la parte norte del corregimiento, existe “una cueva muy inmensa, que antes tenía agua; y que en cualquier momento del día, aparecía, de repente, una mujer muy bonita, cabellona, que se sentaba en las piedras, junto al agua pa’ bañarse”</p>
    ...
    <div class="tarjetas">
        <figure>
            <img src="<?php echo e(asset('local_storage/img/oyelu.jpg')); ?>" >
        </figure>
        <div class="contenido">
            <h3>El Lucio</h3>
            ...
            <a href="<?php echo e(route('lulu')); ?>">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="<?php echo e(asset('local_storage/img/oyema.jpg')); ?>" >
        </figure>
        <div class="contenido">
            <h3>Mamita</h3>
...
La noticia se regó por todo el pueblo, convirtiéndose la casa en un santuario de la Virgen y sitio de romerías de decenas de personas buscando salud para los suyos.</p>
            <a href="<?php echo e(route('ma')); ?>">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="<?php echo e(asset('local_storage/img/missed.jpg')); ?>" >
        </figure>
        <div class="contenido">
            <h3>Mohana</h3>
            <p>En el corregimiento de Arroyo de Piedra, en el municipio de Luruaco, en el occidente del departamento del Atlántico, cuentan los abuelos, existe una leyenda que se ha transmitido de generación en generación.
...
Humberto Currea, pescador nacido en esta tierra, explica que en la parte norte del corregimiento, existe “una cueva muy inmensa, que antes tenía agua; y que en cualquier momento del día, aparecía, de repente, una mujer muy bonita, cabellona, que se sentaba en las piedras, junto al agua pa’ bañarse”</p>
            <a href="<?php echo e(route('mohana')); ?>">Leer más</a>
...
Humberto Currea, pescador nacido en esta tierra, explica que en la parte norte del corregimiento, existe “una cueva muy inmensa, que antes tenía agua; y que en cualquier momento del día, aparecía, de repente, una mujer muy bonita, cabellona, que se sentaba en las piedras, junto al agua pa’ bañarse”</p>
            <a href="<?php echo e(route('ladificil')); ?>">Leer más</a>
...
<?php /**PATH C:\xampp\htdocs\Magica_colombia\resources\views////Departamentos/tarjetaAtlantico.blade.php ENDPATH**/ ?>