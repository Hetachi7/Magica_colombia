...
<div class="container">
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/com.jpg') }}" >
        </figure>
        <div class="contenido">
    ...
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/aish.jpg') }}" >
        </figure>
        <div class="contenido">
            <h3>Mamont</h3>
 ...
 Otros la describen con ojos brotados como de candela, colmillos grandes como los de los zainos, con manos largas y una impresionante expresión de furia, vestida siempre con chamizos, hojas y bejucos.
            ...
            <a href="{{route('mamont')}}">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/sranillos.jpg') }}" >
        </figure>
        <div class="contenido">
            ...
            <a href="{{route('ehoraski')}}">Leer más</a>
    ...
    <div class="tarjetas">
        ...
        <div class="contenido">
            ...
            <a href="{{route('alcoliriz')}}">Leer más</a>
