...
<div class="container">
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/pataentarro.jpg') }}" >
        </figure>
        <div class="contenido">
            <h3>Patetarro</h3>
            ...
            <a href="{{route('patetarru')}}">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/mamont.jpg') }}" >
        </figure>
        <div class="contenido">
...
Vive en sitios enmarañados, con árboles frondosos, alejada del ruido de la civilización y en los bosques cálidos, con animales peligrosos…Los campesinos cuentan que cuando la Madre monte se baña en las cabeceras de los ríos, estos se enturbian y se desbordan, causan inundaciones, borrascas fuertes, que ocasionan daños espantosos
            ...
            <a href="{{route('mamonte')}}">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/jajaja.jpg') }}" >
        </figure>
        <div class="contenido">
            <h3>Pata Sola</h3>
            ...
            <a href="{{route('palone')}}">Leer más</a>
    ...
    <div class="tarjetas">
        <figure>
            <img src="{{ asset('local_storage/img/cositas.jpg') }}" >
        </figure>
        <div class="contenido">
...
Romper un espejo, es señal de mala suerte
            ...
            <a href="{{route('aguerque')}}">Leer más</a>
