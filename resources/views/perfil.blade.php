...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css_index/Estilo-Perfil.css')}}">
</head>
<body>
    ...
    <div class="perfil">
        <div class="header">
         ...
         <div class="foto-perfil">
            <img src=< src="{{ asset('local_storage/img/perfil.jpg') }}" alt="">
         </div>
    ...
    <div id="modal-container" class="modal-container ">
        ...
        <div class="modal" id="modal">
            <form class="form-control  w-50" name="form" id="form" action="">
                ...
                <div>
                    <img id="imagenPerfil" src="{{ asset('local_storage/img/perfil.jpg') }}"   alt="Imagen de Perfil">
                </div>
